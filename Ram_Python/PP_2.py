...
# # #         print("The Sal of me is", self.sal)
# # #
# # #
# # # emp1 = Today("Ram",20000)
# # # emp2 = Today("Sharath", 100000)
# # # print(emp1.__dict__)
# # # print(emp2.__dir__())
# #
# #
...
# # #     print(d.get(key))
# # for key, values in enumerate(d.items()):
# #     print(key, values)
# #
# #
# """printing characters and its count of a string into dictionary using inbuilt method count"""
# # s = "Hello world"
# # d = {}
# # for i in s:
# #     if i not in d:
